        ...
        <div class="row q-col-gutter-md">
          ...
          <div class="col-12 col-md-6 col-lg-6">
            <router-link custom v-slot="{ navigate }" :to="{
              ...
              <div class="text-caption text-grey-10 q-mb-sm cursor-pointer" @click="navigate"
                @keypress.enter="navigate">{{ Object.keys(StickyPost.categories)[0].toLocaleUpperCase() }}</div>
              ...
              <q-tab-panel v-for="(cat, i) in Categories" :key="i" :name="cat.slug">
                ...
                <div class="row q-col-gutter-lg">
                  <div v-for="(post, i) in PostsByCategories.posts" :key="i" class="col-12 col-md-6 col-lg-6 q-mb-xl">
                    <router-link :to="{ name: 'blogs.blog', params: { blog: post.slug } }"
                      class="cursor-pointer text-weight-bold text-h4 text-black">
                      {{ post.title }}
                    </router-link>
                    <div v-html="post.excerpt" class="ellipsis-2-lines text-subtitle text-grey-10 q-my-sm"></div>
                    <div class="row">
...
export default {
  ...
  methods: {
    ...mapActions('blog', ["fetchCategories", "fetchPostsByCategories"]),
