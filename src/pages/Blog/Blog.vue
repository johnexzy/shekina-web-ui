<template>
  <q-page class="blog">
    <section class="author-hero-wrapper" :style="`background-image: url(${Post.featured_image});`">
    ...
    <section class="q-pt-xl q-pb-xs q-px-md">
      <div class="container-blog">
        ...
        }" class="text-subtitle1 text-black" style="font-size: 14px">
      ...
      <div class="container-blog">
        <div class="row q-col-gutter-lg">
          <div class="col-12 col-md-3 col-lg-3 column items-start">
            <div class="text-subtitle1 text-black q-mb-md">SHARE THIS ARTICLE</div>
            <a class="share-btn q-mb-sm"
              ...
              target="_blank">
              <q-icon size="25px" name="ion-logo-facebook" class="q-mr-md" />Facebook
            </a>
            <a class="share-btn q-mb-sm"
              :href="`http://twitter.com/intent/tweet/?text=${shareInfo.text} \n${shareInfo.link}`" target="_blank">
              <q-icon size="25px" name="ion-logo-twitter" class="q-mr-md" />Twitter
            </a>
            <a class="share-btn q-mb-sm" :href="`https://www.linkedin.com/sharing/share-offsite/?url=${shareInfo.link}`"
              target="_blank">
              <q-icon size="25px" name="ion-logo-linkedin" class="q-mr-md" />Linkedin
            </a>
            <a class="share-btn q-mb-sm" target="_blank"
              :href="`mailto:?subject=${shareInfo.head}&body=${shareInfo.text} ${shareInfo.link}`">
              <q-icon size="25px" name="ion-mail" class="q-mr-md" />Mail
            </a>
            <a class="share-btn" :href="`whatsapp://send?text=${shareInfo.text} ${shareInfo.link}`">
              <q-icon size="25px" name="ion-logo-whatsapp" class="q-mr-md" />Whatsapp
            </a>
          </div>
          <div class="col-12 col-md-6 col-lg-6">
            <div v-html="Post.content" class="blog-html html" />

            <div class="q-my-xl">last updated on: {{ formatDateString(Post.modified) }}</div>
      ...
      <div class="container-blog">
        ...
        <div class="row q-col-gutter-lg">
          <div v-for="(s, i) in FeaturedPosts" :key="i" class="col-12 col-md-3 col-lg-3">
            ...
            <div>
              <q-img style="max-height: 150px" @click="$router.push({ name: 'blogs.blog', params: { blog: s.slug } })"
                :src="s.featured_image" class="cursor-pointer" />
            </div>

            <router-link :to="{ name: 'blogs.blog', params: { blog: s.slug } }"
...
export default {
  ...
  computed: {
    ...mapGetters('blog', ["Post", "FeaturedPosts"]),
    /**
     * Share Meta Data
     * @return Object
     */
...
.blog {
  ...
  section.hero-wrapper {
    background: linear-gradient(100deg, rgba(22, 21, 21, 0.8) 0%, rgb(80, 76, 53) 25%);
